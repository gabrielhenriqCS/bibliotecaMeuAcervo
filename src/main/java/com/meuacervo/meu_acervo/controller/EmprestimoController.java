...
public class EmprestimoController {
    ...
    public ResponseEntity<Void> deleteEmprestimo(@PathVariable("id") Integer id) {
        emprestimoService.deletarPeloId(id);
